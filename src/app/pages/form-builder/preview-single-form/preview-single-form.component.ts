...
@Component({
  selector: 'app-preview-single-form',
  templateUrl: './preview-single-form.component.html',
  styleUrls: ['./preview-single-form.component.scss']
})
export class PreviewSingleFormComponent implements OnInit {
  @Input() elementsForm: any;
  @Input() fields: any;
  @Input() formName: any;
  ...
  ngOnInit(): void {
    ...
    console.log("fields", this.fields, this.formName);
  }
