...
@Component({
  selector: 'app-employer-vacancy',
  templateUrl: './employer-vacancy.component.html',
  styleUrls: ['./employer-vacancy.component.scss']
})
export class EmployerVacancyComponent implements OnInit {
  modules = {
    toolbar: [
  ...
  let receivers = this.routeForm.value.application_receiver;
    ...
    if(this.selectedVacancyId){
       if(this.essentials.value.parent_company_id){
        obj['parent_company_id'] =  this.selectedVacancy.parent_company_id;
        obj['company_id'] = this.selectedVacancy.company_id;
        obj['company_name']= this.selectedVacancy?.company_info?.company_name;
        obj['company_logo'] = this.selectedVacancy?.company_info?.company_logo;
