...
@Component({
  selector: 'app-view-my-company-submissions',
  templateUrl: './view-my-company-submissions.component.html',
  styleUrls: ['./view-my-company-submissions.component.scss']
})
export class ViewMyCompanySubmissionsComponent  implements OnInit {
