...
@Component({
  ...
  styleUrls: ['./view-company-profile.component.scss']
})
export class ViewCompanyProfileComponent implements OnInit {
  ...
  getAllVacancies() {
    this.service.getAllVacancies({ company_id: this.companyId,  view_type:"employer", }).subscribe((res: any) => {
  ...
  goToSiteVisitDetail(siteVisit) {
    this.router.navigate(['/employer/site-visits-details'], { queryParams: { companyId: this.companyId, site_visit_id: siteVisit?.site_visit_id } })
  }
