...
@Component({
  selector: 'app-my-view-site-visits-details',
  templateUrl: './my-view-site-visits-details.component.html',
  styleUrls: ['./my-view-site-visits-details.component.scss']
})
export class MyViewSiteVisitsDetailsComponent implements OnInit {
  ...
  goBack() {
    // this.location.back();
      this.router.navigate(['/employer/view-company-profile'], { queryParams: { company_id: this.companyId, tab:'site' } });
  }
