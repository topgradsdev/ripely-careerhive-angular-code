...
@Component({
  selector: 'app-view-subsidiaries-list',
  templateUrl: './view-subsidiaries-list.component.html',
  styleUrls: ['./view-subsidiaries-list.component.scss']
})
export class ViewSubsidiariesListComponent implements OnInit {
    ...
    gotoProfile(data){
      console.log("data", data)
        this.router.navigate(["/employer/view-company-details"], {queryParams: {company_id: data._id}});
    }
}
