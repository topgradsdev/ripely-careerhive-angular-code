...
@Component({
  selector: 'app-employer-onboarding-self',
  templateUrl: './employer-onboarding-self.component.html',
  styleUrls: ['./employer-onboarding-self.component.scss']
})
export class EmployerOnboardingSelfComponent implements OnInit {
  isDisabledNav = false;
...
userProfile:any = '';
  ngOnInit(): void {
    ...
    this.loggedInUserId = this.userProfile.contact_person_id;
    ...
    this.getEmployerProfile(this.userProfile?._id);
  }
 ...
 addSpacesInABN() {
  ...
  submitEmployerProfile() {
    ...
    this.service.updateProfileSelfSourceCompany(payload).subscribe(res => {
      this.service.showMessage({
