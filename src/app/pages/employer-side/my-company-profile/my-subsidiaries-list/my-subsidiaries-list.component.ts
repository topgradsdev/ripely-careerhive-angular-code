...
@Component({
  selector: 'app-my-subsidiaries-list',
  templateUrl: './my-subsidiaries-list.component.html',
  styleUrls: ['./my-subsidiaries-list.component.scss']
})
export class MySubsidiariesListComponent implements OnInit {
    ...
    gotoProfile(data){
      ...
      this.router.navigate(["/employer/view-company-details"], {queryParams: {company_id: data._id, tab:'overview'}});
    }
}
