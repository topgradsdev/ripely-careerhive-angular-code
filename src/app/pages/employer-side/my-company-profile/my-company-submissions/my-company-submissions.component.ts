...
@Component({
  selector: 'app-my-company-submissions',
  templateUrl: './my-company-submissions.component.html',
  styleUrls: ['./my-company-submissions.component.scss']
})
export class MyCompanySubmissionsComponent  implements OnInit {
