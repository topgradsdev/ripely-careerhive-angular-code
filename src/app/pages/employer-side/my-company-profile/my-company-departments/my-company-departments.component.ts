...
@Component({
  selector: 'app-my-company-departments',
  templateUrl: './my-company-departments.component.html',
  styleUrls: ['./my-company-departments.component.scss']
})
export class MyCompanyDepartmentsComponent   implements OnInit {
  placementId: any;
