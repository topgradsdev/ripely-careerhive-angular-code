...
@Component({
  selector: 'app-my-company-vacancies-view',
  templateUrl: './my-company-vacancies-view.component.html',
  styleUrls: ['./my-company-vacancies-view.component.scss']
})
export class MyCompanyVacanciesViewComponent implements OnInit {
...
userDetail:any;
 ...
 this.vacancylimit = 5;
  ...
  editVacancy() {
    sessionStorage.setItem("redirect", JSON.stringify({tab:this.activeTab, company_id:this.employerProfile._id}));
