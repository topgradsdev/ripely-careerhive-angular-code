...
@Component({
  selector: 'app-site-visits-details',
  templateUrl: './site-visits-details.component.html',
  styleUrls: ['./site-visits-details.component.scss']
})
export class SiteVisitsDetailsComponent implements OnInit {
  ...
  goBack() {
    ...
    this.router.navigate(['/admin/wil/view-company-details'], { queryParams: { company_id: this.companyId, tab:'site' } });
    // this.router.navigate(['/current-page'], { state: { tab: 'site' } });
